...
//       render: (row: AdTableData) => (
//         <span
//           className={`px-3 py-1 rounded-full text-sm font-semibold ${row.expire === 'Expired'
...
//       render: (row: AdTableData) => (
//         <span
//           className={`px-3 py-1 rounded-full text-sm font-semibold ${row.status === 'Deleted'
//               ? 'text-red-600 bg-red-100 border border-red-300'
//               : 'text-green-600 bg-green-100 border border-green-300'
//             }`}
//         >
