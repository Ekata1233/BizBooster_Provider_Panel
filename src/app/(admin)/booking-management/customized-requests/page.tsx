...
const CustomizedRequests = () => {
  ...
  const data = checkouts.filter((checkout: any) => checkout.isVerified === false).map((checkout: any) => ({
      ...
      <div className="space-y-6">
        <ComponentCard title="Customized Requests">
          ...
          {data.length > 0 ? (
            ...
            <p className="text-sm text-gray-500">No customized request data to display.</p>
          )}
        </ComponentCard>
      </div>
    </div>
