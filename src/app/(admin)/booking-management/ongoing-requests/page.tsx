...
const OngoingRequests = () => {
  ...
  const data = checkouts.filter((checkout: any) => checkout.isAccepted === true && checkout.isCompleted === false).map((checkout: any) => ({
      ...
      <div className="space-y-6">
        <ComponentCard title="Ongoing Requests">
          ...
          {data.length > 0 ? (
            ...
            <p className="text-sm text-gray-500">No ongoing request data to display.</p>
          )}
        </ComponentCard>
      </div>
    </div>
