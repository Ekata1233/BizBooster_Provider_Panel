      ...
      <div className="relative ml-6 mt-6">
        {steps.length === 0 ? (
          <div className="text-center text-gray-500 text-sm italic">
            No progress has been recorded for this booking yet. Please check back
          ...
          steps.map((step, index) => (
            <div key={index} className="relative pl-10">
              ...
              <div className="mb-8 ml-7">
                ...
                {lead?.leads?.[index]?.document && (
                  <div className="">
                    <a
                      href={lead.leads[index].document}
                      target="_blank"
                    ...
                    {/* <div className="mt-1">
                      <img
                        src={lead.leads[index].document}
                        alt="Lead Document"
                        className="w-32 h-32 object-cover rounded-md border border-gray-200 mt-1"
                      />
                    </div> */}
                  </div>
                )}
