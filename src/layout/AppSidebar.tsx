...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main", "others", "booking"].forEach((menuType) => {
      const items =
        menuType === "main"
          ? navItems
          : menuType === "others"
        ...
        if (nav.subItems) {
          nav.subItems.forEach((subItem) => {
            if (isActive(subItem.path)) {
              setOpenSubmenu({
                type: menuType as "main" | "others" | "booking",
                index,
              });
              submenuMatched = true;
            }
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "others" | "booking") => {
